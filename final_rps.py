...
# picture
rock_img = ImageTk.PhotoImage(Image.open("rock-user(2).png"))
paper_img = ImageTk.PhotoImage(Image.open("paper-user (1).png"))
scissor_img = ImageTk.PhotoImage(Image.open("scissors-user(1).png"))
rock_img_comp = ImageTk.PhotoImage(Image.open("rock-computer(2).png"))
paper_img_comp = ImageTk.PhotoImage(Image.open("paper-computer(1).png"))
scissor_img_comp = ImageTk.PhotoImage(Image.open("scissors-computer(1).png"))
# insert picture
...
def updateChoice(x):
   ...
   else: comp_label.configure(image=scissor_img_comp)
